...
float LF[] = {0.8,0.81,0.82,0.83,0.85,0.88,0.93,1.01,1.14,1.35,1.69,2.24,3.13,3.5};
ros::Subscriber sub;
ros::Publisher pub;
...
int main(int argc, char **argv)
{
   ...
   */
  sub = n.subscribe("/camera/depth/points", 10, chatterCallback);
  pub = n.advertise<nav_msgs::Path>("way_point",10);
  /**
